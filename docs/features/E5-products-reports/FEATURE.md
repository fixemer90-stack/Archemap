...
| ID | Описание | Статус |
|---|---|---|
| S01 | [Self-отчёт: архетипический портрет, evidence-trail, PDF, Celery-задача](S01-self-report.md) | ⬜ Не начато |
...
| S07 | [REST API отчётов: POST generate, GET list/detail, pagination, permissions](S07-report-api.md) | ⬜ Не начато |
