...
Archemap — веб-платформа для управления подписками и аккаунтами. Пользователи подключают подписки, отслеживают расходы, получают уведомления о продлениях. Платформа предоставляет multi-provider авторизацию (VK ID как первый IdP), платёжный оркестратор (Stripe/PayPal/ЮKassa) и модульный биллинг.

**Целевой пользователь:** SaaS-компании и сервисы с подписочной моделью, нуждающиеся в единой платформе для управления подписками, платежами и аккаунтами.
