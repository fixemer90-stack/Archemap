# Canonical Data Rules: Socionics → Astrotype
...
**Принцип:** соционика описывает 16 типов личности через 8 психических функций. Astrotype вычисляет 8 функций через астрологические данные (стихии, модальности, планеты, дома). Правила маппят одно на другое.
...
5. **Astrotype ≠ соционика:** Astrotype использует астрологические данные, а не соционические тесты. Маппинг — гипотеза, не факт
