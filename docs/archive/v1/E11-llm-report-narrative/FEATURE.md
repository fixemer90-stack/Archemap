...
Фича опирается на technical design: [`docs/design/llm-report-narrative-architecture.md`](llm-report-narrative-architecture.md).

Для быстрого понимания реального сценария использования и того, какой вход получает LLM, см. [`WORKFLOW.md`](Archemap/docs/features/v1/E11-llm-report-narrative/WORKFLOW.md).

Для интеграции frontend/backend по endpoint'ам, статусам и regenerate-flow см. [`API.md`](Archemap/docs/features/v1/E11-llm-report-narrative/API.md).
