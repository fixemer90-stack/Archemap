# V2-E8 S01: Build report assembler
...
Combine segment artifacts into final report without rewriting factual content.
...
```bash
cd backend && uv run pytest tests/unit/test_astrotype_v2/test_report_assembler.py::test_assemble_natal_report_v2_preserves_validated_segment_text_and_stable_order tests/unit/test_astrotype_v2/test_report_assembler.py::test_assemble_natal_report_v2_builds_evidence_index_separate_from_narrative_first_sections -v --tb=short
```
