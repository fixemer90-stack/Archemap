...
| ----- | ------------------------------------------ | ------------ | ---------------------------------------- |
| S01   | Human storytelling contract and tone guide | ⬜ Не начато | `S01-human-storytelling-contract.md`     |
...
- [ ] Assembler preserves enough stage prose to avoid one-paragraph compression while still keeping sections readable.
