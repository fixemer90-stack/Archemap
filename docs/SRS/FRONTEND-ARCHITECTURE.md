# Astrotype — Архитектура фронтенда
...
Astrotype — астрологическая платформа, предоставляющая пользователям натальные карты, совместимость, транзиты и персональные прогнозы. Фронтенд построен как одностраничное приложение на базе Next.js с серверным рендерингом.
...
export const metadata: Metadata = {
  title: 'Панель управления — Astrotype',
}
