        ...
        <section className="container mx-auto px-4 pb-16">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="glass p-6 space-y-3">
              ...
              <p className="text-sm text-[#D8DCE8] leading-relaxed">
                16 типов личности по Model A. Вы увидите свой тип (например, ЛИЭ
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-[#D8DCE8]">
                  ...
                  соционический тип и профиль. Каждый вывод — числовой
                  показатель, уровень уверенности и список оснований. Никакого
                  AI — только правила.
                </p>
              </div>
            </div>
        ...
        <section className="container mx-auto px-4 pb-16">
          ...
          <div className="grid gap-4 md:grid-cols-2 max-w-2xl mx-auto">
            {[
              ...
              "Показатель: числовой показатель выраженности (0–100%)",
              "Уверенность: насколько надёжён вывод с учётом входных данных",
