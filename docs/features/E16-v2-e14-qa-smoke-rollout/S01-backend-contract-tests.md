# V2-E14 S01: Add backend contract tests
...
Test schemas, storage, facts, outline, segments and report assembly.
...
uv run ruff check app/modules/astrotype_v2/qa_smoke.py tests/unit/test_astrotype_v2/test_qa_smoke_rollout.py
uv run mypy app/modules/astrotype_v2/qa_smoke.py tests/unit/test_astrotype_v2/test_qa_smoke_rollout.py
```
