# V2-E12 S05: Prepare push and billing foundation
...
This story belongs to `V2-E12 — Android MVP path`.

Document/implement FCM and Google Play Billing bridge when needed.
...
| `docs/features/E16-v2-e12-android-mvp-path/` | Keep feature/story docs synchronized. |
