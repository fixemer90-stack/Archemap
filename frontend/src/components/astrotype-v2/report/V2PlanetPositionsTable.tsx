...
export function V2PlanetPositionsTable({
  ...
  return (
    <section data-v2-calculation-block="planet_positions">
      <div className="rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.055),rgba(255,255,255,0.025))] shadow-[0_20px_70px_rgba(0,0,0,0.3)]">
        <h3 className="px-5 pt-5 text-[21px] font-semibold text-[#F4EADB]">
          Положения планет
        </h3>
