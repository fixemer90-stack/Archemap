...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("profile_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("person_profiles.id", ondelete="CASCADE"), nullable=False, index=True),
        ...
        sa.Column("report_data", _json_col, nullable=False, server_default=_default),
