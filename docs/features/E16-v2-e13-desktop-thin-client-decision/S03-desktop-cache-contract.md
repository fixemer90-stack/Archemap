# V2-E13 S03: Define desktop cache contract
...
Specify local cache/draft boundaries and no canonical SQLite storage.
...
Decision recorded: cache/drafts only; PostgreSQL remains canonical and desktop cache is disposable.

Decision artifact: `docs/architecture/astrotype-v2-desktop-thin-client-decision.md`

```bash
cd backend && uv run pytest tests/unit/test_astrotype_v2/test_desktop_thin_client_decision.py::test_desktop_cache_contract_forbids_local_source_of_truth_and_embedded_keys -v --tb=short
```
