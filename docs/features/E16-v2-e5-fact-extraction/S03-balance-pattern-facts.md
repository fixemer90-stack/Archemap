# V2-E5 S03: Generate balance and pattern facts
...
This story belongs to `V2-E5 — Fact extraction`.

Create facts for elements, modalities, house emphasis, angularity and chart patterns.
...
| `docs/features/E16-v2-e5-fact-extraction/` | Keep feature/story docs synchronized. |
