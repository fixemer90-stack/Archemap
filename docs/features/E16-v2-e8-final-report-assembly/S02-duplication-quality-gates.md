# V2-E8 S02: Add duplication/evidence quality gates
...
Validate forbidden-theme expansion, evidence coverage and section completeness.
...
```bash
cd backend && uv run pytest tests/unit/test_astrotype_v2/test_report_assembler.py::test_assemble_natal_report_v2_rejects_missing_not_ready_or_duplicate_sections tests/unit/test_astrotype_v2/test_report_assembler.py::test_assemble_natal_report_v2_quality_gates_reject_repeated_or_ungrounded_sections -v --tb=short
```
