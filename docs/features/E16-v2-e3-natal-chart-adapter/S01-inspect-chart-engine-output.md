# V2-E3 S01: Inspect current chart output
...
Map current chart snapshot fields to v2-compatible placements, houses, aspects and calculation metadata.
...
- [x] Current chart-engine `ChartData` fields are mapped to v2 placements, houses, aspects and calculation metadata.
