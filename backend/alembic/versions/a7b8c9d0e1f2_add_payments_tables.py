...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "description", sa.String(500), nullable=False, server_default=""
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_id", sa.String(255), nullable=True, index=True
        ),
        ...
        sa.Column("error_message", sa.Text, nullable=True),
        sa.Column(
            "idempotency_key", sa.String(255), nullable=True, unique=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
