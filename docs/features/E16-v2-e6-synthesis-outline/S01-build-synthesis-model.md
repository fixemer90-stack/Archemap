# V2-E6 S01: Build synthesis model
...
Create `NatalSynthesisV2` with dominant themes, tensions, resources and growth vectors.
...
```bash
cd backend && uv run pytest tests/unit/test_astrotype_v2/test_synthesis.py -v --tb=short
```
