...
- [x] Cookie-first browser session: login/refresh/logout через HttpOnly cookies, frontend не хранит JWT
...
- Workflow: [WORKFLOW.md](Archemap/docs/features/v1/E2-identity/WORKFLOW.md)
- API contract: [API.md](Archemap/docs/features/v1/E2-identity/API.md)
- SRS: [SRS-E2-identity-auth.md](SRS-E2-identity-auth.md)
