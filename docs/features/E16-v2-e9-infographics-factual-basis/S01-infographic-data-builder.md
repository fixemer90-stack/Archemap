# V2-E9 S01: Build infographic data builder
...
Generate wheel, table, balance, house-emphasis and aspect-network datasets without LLM.
...
```bash
cd backend && uv run pytest tests/unit/test_astrotype_v2/test_infographic_data.py::test_build_natal_infographic_data_v2_matches_canonical_lower_layer_blocks tests/unit/test_astrotype_v2/test_infographic_data.py::test_build_natal_infographic_data_row_uses_v2_model_without_side_effects -v --tb=short
```
