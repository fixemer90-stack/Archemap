...
Пользователь                          Система
    ...
    ├─ Регистрация / вход ───────────────►│ E2 ✅
    │                                     │
    ├─ Вводит дату, время, место ────────►│ E3 ✅ (профиль + карта)
    │                                     │
    │                              ┌──────┤
    │                              │ E4   │ Rule engine интерпретирует карту
    │                              │ ⬜    │ YAML-правила → текст
    │                              └──────┤
    │                                     │
    │                              ┌──────┤
    │                              │ E5.S01│ Рендерит Self-отчёт
    │                              │ ⬜    │ Jinja2 шаблоны → HTML/PDF
    │                              └──────┤
    │                                     │
    │◄──── "Вот твой архетипический ──────│
    │       портрет: Стратег, 78/100"      │
```
